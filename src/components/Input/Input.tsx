...
export const Input = ({title, placeholder, type, validator, error, validationMessage, props, classes}: Props) => {

    return (
        <div
            className={classNames(classes, styles.input__wrapper, {[styles.input__wrapper_submit]: type === "submit"})}>
